...
export const RUNTIME_LANGUAGE_ARTIFACTS:
  readonly RuntimeLanguageArtifactMetadata[] = [
    ...
    },
    {
      ...
      sourceHash: "fnv1a64:7dbbedbb0aeea9e2",
      typescriptHash: "fnv1a64:66ae769714cafa76",
      wasmHash: "fnv1a64:5824c5a5cb1710a1",
    },
    {
      name: "lexer_runtime",
      entry: "dfaTransition",
    ...
    },
    {
      ...
      sourceHash: "fnv1a64:8fc21c5e1d7a52f0",
      typescriptHash: "fnv1a64:1b6b6c1fc0b568c6",
      wasmHash: "fnv1a64:c091dff401493757",
    },
    {
      name: "parser_production_runtime",
...
export const RUNTIME_LANGUAGE_ARTIFACTS_HASH =
  "fnv1a64:2db6f670cc7304b0" as const;
