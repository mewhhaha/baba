...
import { buildGrammarAstSchema, type GrammarAstSchema } from "./grammar_ast.ts";
import { buildGrammarCstSchema, type GrammarCstSchema } from "./grammar_cst.ts";
import type {
  AnalyzedGrammar,
...
import {
  ...
  type GrammarParserCoreOptions,
  type GrammarParserCorePlan,
} from "./grammar_parser_core.ts";
import {
  buildGrammarPrattPlan,
  type GrammarPrattPlan,
} from "./grammar_pratt.ts";
...
import {
  ...
  stringProperty,
  visitJson,
} from "./portable_plan_shared.ts";

const FORMAT = "baba-portable-plan";
const VERSION = 2;
const SEMANTICS = "baba-portable";

export interface GrammarPortablePlan {
  readonly format: "baba-portable-plan";
  readonly version: 2;
  readonly semantics: "baba-portable";
  readonly grammar: GrammarPortableGrammarIdentity;
  readonly symbols: GrammarPortableSymbols;
  readonly lexer: GrammarPortableLexerPlan;
  readonly parser: GrammarPortableParserPlan;
  readonly expressions: GrammarPortableExpressionPlan;
  readonly recovery: GrammarPortableRecoveryPlan;
  readonly cst: GrammarCstSchema;
  readonly ast: GrammarAstSchema;
  readonly diagnostics: GrammarPortableDiagnosticsPlan;
  readonly debug: GrammarPortableDebugPlan;
  readonly statistics: GrammarPortablePlanStatistics;
  readonly targets: GrammarPortableTargetPlan;
  readonly grammarIr: GrammarPortableGrammarIr;
}

export interface GrammarPortablePlanMetadata {
  readonly format: GrammarPortablePlan["format"];
  readonly version: GrammarPortablePlan["version"];
  readonly semantics: GrammarPortablePlan["semantics"];
  readonly hash: string;
}

export interface GrammarPortableGrammarIdentity {
  readonly name: string;
  readonly rootRule: GrammarRuleId;
  readonly rootRuleName: string;
  readonly hash: string;
}

export interface GrammarPortableSymbols {
  readonly tokens: readonly GrammarPortableNamedSymbol[];
  readonly rules: readonly GrammarPortableNamedSymbol[];
  readonly literals: readonly GrammarPortableLiteralSymbol[];
  readonly modes: readonly GrammarPortableNamedSymbol[];
  readonly fields: readonly GrammarPortableNamedSymbol[];
  readonly constructors: readonly GrammarPortableNamedSymbol[];
  readonly terminals: readonly TerminalInfo[];
  readonly nonterminals: readonly NonterminalInfo[];
}

export interface GrammarPortableNamedSymbol {
  readonly id: number;
  readonly name: string;
}

export interface GrammarPortableLiteralSymbol {
  readonly id: number;
  readonly value: string;
}

export interface GrammarPortableLexerPlan {
  readonly defaultMode: number;
  readonly channels: readonly string[];
  readonly modes: readonly GrammarPortableLexerMode[];
  readonly contextualCandidates: readonly GrammarPortableContextualCandidate[];
  readonly layout: GrammarPortableLayoutPlan;
}

export interface GrammarPortableLexerMode {
  readonly id: number;
  readonly name: string;
  readonly specs: readonly GrammarPortableLexerSpec[];
  readonly dfa: Dfa;
}

export interface GrammarPortableLexerSpec {
  readonly id: number;
...
export interface GrammarPortableContextualCandidate {
  readonly tokenId: number;
  readonly name: string;
...
export interface GrammarPortableLayoutPlan {
  readonly enabled: false;
}

export interface GrammarPortableParserPlan {
  readonly startRule: string;
  readonly eofTerminal: number;
  readonly startState: number;
  readonly terminals: readonly TerminalInfo[];
  readonly nonterminals: readonly NonterminalInfo[];
  readonly productions: readonly GrammarPortableProduction[];
  readonly states: readonly GrammarPortableLrState[];
  readonly actions: readonly GrammarPortableActionRow[];
  readonly gotos: readonly GrammarPortableGotoRow[];
  readonly expectedTerminals: readonly GrammarPortableExpectedTerminalRow[];
  readonly statistics: LrPlanningStats;
}

export interface GrammarPortableProduction {
  readonly id: number;
...
export interface GrammarPortableLrState {
  readonly id: number;
  readonly items: readonly GrammarPortableLrItem[];
}

export interface GrammarPortableLrItem {
  readonly production: number;
  readonly dot: number;
  readonly lookaheads: readonly number[];
}

export interface GrammarPortableActionRow {
  readonly state: number;
  readonly entries: readonly GrammarPortableActionEntry[];
}

export interface GrammarPortableActionEntry {
  readonly terminal: number;
  readonly actions: readonly LrAction[];
}

export interface GrammarPortableGotoRow {
  readonly state: number;
  readonly entries: readonly GrammarPortableGotoEntry[];
}

export interface GrammarPortableGotoEntry {
  readonly nonterminal: number;
  readonly target: number;
}

export interface GrammarPortableExpectedTerminalRow {
  readonly state: number;
  readonly terminals: readonly number[];
}

export interface GrammarPortableExpressionPlan {
  readonly pratt: GrammarPrattPlan;
}

export interface GrammarPortableRecoveryPlan {
  readonly strategy: "single-token-insert-delete";
  readonly maxRecoveries: number;
  readonly expectedTerminals: readonly GrammarPortableExpectedTerminalRow[];
}

export interface GrammarPortableDiagnosticsPlan {
  readonly sourceSpanUnit: "utf16-code-units";
  readonly codes: readonly string[];
  readonly terminalDisplays: readonly GrammarPortableNamedSymbol[];
  readonly ruleDisplays: readonly GrammarPortableNamedSymbol[];
}

export interface GrammarPortableDebugPlan {
  readonly profile: "production" | "debug";
  readonly lrItems: boolean;
  readonly sourceExcerpts: boolean;
}

export interface GrammarPortablePlanStatistics {
...
export interface GrammarPortableTargetPlan {
  readonly typescript: {
  ...
  readonly parserKit: {
    readonly artifact: "portable-plan-json";
  };
  readonly wasm: {
...
export interface GrammarPortableGrammarIr {
  readonly name: string;
  readonly rootRule: GrammarRuleId;
  ...
  readonly modules: AnalyzedGrammar["modules"];
  readonly exports: AnalyzedGrammar["exports"];
  readonly extensions: AnalyzedGrammar["extensions"];
  readonly reachableRules: readonly GrammarRuleId[];
  readonly reachableTokens: readonly GrammarTokenId[];
  readonly reachableLiterals: readonly GrammarLiteralId[];
}

export interface GrammarPortablePlanBuildOptions
  extends GrammarParserCoreOptions {
  readonly debugProfile?: "production" | "debug";
}

export interface GrammarPortablePlanBuildResult {
  readonly plan: GrammarPortablePlan | undefined;
  readonly metadata: GrammarPortablePlanMetadata | undefined;
  readonly diagnostics: readonly Diagnostic[];
  readonly parser: GrammarParserCorePlan | undefined;
}

export function buildGrammarPortablePlan(
  analyzed: AnalyzedGrammar,
  options: GrammarPortablePlanBuildOptions = {},
): GrammarPortablePlanBuildResult {
  const diagnostics: Diagnostic[] = [...analyzed.diagnostics];
  if (analyzed.rootRule === undefined) {
    diagnostics.push({
      code: "GRAMMAR_PORTABLE_MISSING_ROOT",
      severity: "error",
      message: "Cannot build a portable grammar plan without a root rule.",
    });
    return {
      plan: undefined,
      metadata: undefined,
  ...
  const parser = buildGrammarParserCorePlan(analyzed, options);
  const pratt = buildGrammarPrattPlan(analyzed);
  const cst = buildGrammarCstSchema(analyzed);
  const ast = buildGrammarAstSchema(analyzed);
  ...
  const planWithoutStatistics = {
    ...
    targets: {
      ...
      parserKit: { artifact: "portable-plan-json" },
      wasm: {
        status: "deferred",
        reason:
          "The generic Wasm executor does not execute this portable grammar plan yet.",
      },
      treeSitter: {
        status: "deferred",
        reason:
          "Tree-sitter generation needs a dedicated grammar subset mapper before it can safely emit artifacts.",
      },
    },
    grammarIr: grammarIr(analyzed),
  } satisfies Omit<GrammarPortablePlan, "statistics">;
  ...
  return {
    plan,
    metadata: grammarPortablePlanMetadata(plan),
    diagnostics,
    parser,
  };
}

export function serializeGrammarPortablePlanJson(
  plan: GrammarPortablePlan,
): string {
  return `${JSON.stringify(canonicalValue(plan), null, 2)}\n`;
}

export function parseGrammarPortablePlanJson(
  source: string,
): GrammarPortablePlan | { diagnostics: readonly Diagnostic[] } {
  let parsed: unknown;
  try {
    parsed = JSON.parse(source);
  } catch (error) {
    let message = "Invalid grammar portable plan JSON.";
    if (error instanceof Error) {
      message = `Invalid grammar portable plan JSON: ${error.message}`;
    }
    return {
      diagnostics: [{
        code: "GRAMMAR_PORTABLE_JSON_PARSE_ERROR",
        severity: "error",
        message,
      }],
    };
  }
  const diagnostics = validateGrammarPortablePlan(parsed);
  if (diagnostics.length > 0) {
    return { diagnostics };
  }
  return parsed as GrammarPortablePlan;
}

export function grammarPortablePlanMetadata(
  plan: GrammarPortablePlan,
): GrammarPortablePlanMetadata {
  return {
    format: plan.format,
...
export function portablePlanStatistics(
  ...
  return {
    ...
    serializedJsonBytes: new TextEncoder().encode(
      serializeGrammarPortablePlanJson(stablePlan),
    ).length,
  };
}

export function validateGrammarPortablePlan(plan: unknown): Diagnostic[] {
  const diagnostics: Diagnostic[] = [];
  const fail = (path: string, message: string) => {
    diagnostics.push({
      code: "GRAMMAR_PORTABLE_PLAN_INVALID",
      severity: "error",
...
export function grammarPortablePlanToAnalyzed(
  plan: GrammarPortablePlan,
): AnalyzedGrammar {
  return {
...
function lexerChannels(analyzed: AnalyzedGrammar): string[] {
...
function tokenChannel(token: AnalyzedGrammarToken): string {
...
function grammarIr(analyzed: AnalyzedGrammar): GrammarPortableGrammarIr {
  if (analyzed.rootRule === undefined) {
...
function gotoRows(plan: GrammarParserCorePlan): GrammarPortableGotoRow[] {
...
function expectedTerminalRows(
  plan: GrammarParserCorePlan,
): GrammarPortableExpectedTerminalRow[] {
  return [...plan.lr.actions.entries()]
    .sort(([left], [right]) => left - right)
    .map(([state, row]) => ({
      state,
...
function productionStableId(
  ...
  const payload = {
    semantics: "baba-grammar-production",
...
function terminalStableKey(plan: GrammarParserCorePlan, id: number): string {
...
function diagnosticCodes(diagnostics: readonly Diagnostic[]): string[] {
  ...
  codes.add("GRAMMAR_LEX_UNEXPECTED_CHARACTER");
  codes.add("GRAMMAR_PARSE_UNEXPECTED_TOKEN");
  codes.add("GRAMMAR_PARSE_RECOVERY");
  codes.add("AST_MATERIALIZE_UNEXPECTED_TOKEN");
  codes.add("AST_MATERIALIZE_TRAILING_TOKEN");
  return [...codes].sort();
}

function zeroStatistics(): GrammarPortablePlanStatistics {
  return {
    lexerModes: 0,
    lexerStates: 0,
    lexerTransitions: 0,
...
function grammarHash(analyzed: AnalyzedGrammar): string {
  const payload = {
    name: analyzed.name,
    rootRule: analyzed.rootRule,
    tokens: analyzed.tokens,
...
function hashPlan(plan: GrammarPortablePlan): string {
