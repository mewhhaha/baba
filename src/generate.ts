...
Scoped metadata captures are not generated yet. Model those as explicit query entries for now, or add a post-generation query layer for project-specific scopes.
`;
}
